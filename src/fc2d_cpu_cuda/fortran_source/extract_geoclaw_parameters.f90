...
subroutine get_geoclaw_parameters( coord_sys, grav_, earth_rad_, deg2rad_, &
    ...
    ! =================== module imports ===================
    USE geoclaw_module, only: coordinate_system, grav, earth_radius, deg2rad
    ...
    integer, intent(out) :: coord_sys, num_manning_, friction_index_
    double precision, intent(out) :: grav_, earth_rad_, deg2rad_
