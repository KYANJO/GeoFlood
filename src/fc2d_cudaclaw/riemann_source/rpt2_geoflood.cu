...
__device__ cudaclaw_cuda_rpt2_t cudaclaw_rpt2 = cudaflood_rpt2;

void cudaclaw_assign_rpt2(cudaclaw_cuda_rpt2_t *rpt2)
{
    cudaError_t ce = cudaMemcpyFromSymbol(rpt2, cudaclaw_rpt2, sizeof(cudaclaw_cuda_rpt2_t));
