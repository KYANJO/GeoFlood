...
__device__ cudaclaw_cuda_rpn2_t cudaclaw_rpn2 = cudaflood_rpn2;

void cudaclaw_assign_rpn2(cudaclaw_cuda_rpn2_t *rpn2)
{
    cudaError_t ce = cudaMemcpyFromSymbol(rpn2, cudaclaw_rpn2, sizeof(cudaclaw_cuda_rpn2_t));
    if(ce != cudaSuccess)
    {
