c===========================================================================
       function topointegral_geo(xim,xcell,xip,yjm,ycell,yjp,
...
c               if (icoordsys.eq.1) then !cartesian rectangle
     ...
     &                                         dxx,dyy,
     &                                         z11,z12,z21,z22)
c                elseif (icoordsys.eq.2) then !integrate on surface of sphere
