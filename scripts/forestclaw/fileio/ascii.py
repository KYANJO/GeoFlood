...
# import forestclaw as forestclaw
import forestclaw

from .. import Dimension, Patch
from pyclaw.fileio.ascii import write
from pyclaw.fileio.ascii import read
...
def read_patch_header(f, num_dim):
    ...
    :Output:
     - *patch* - (pyclaw.geometry.Patch) Initialized patch represented
       by the header data.
    """
