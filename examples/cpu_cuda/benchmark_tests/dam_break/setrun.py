...
#------------------------------
   ...
   # Gauges ( append lines of the form  [gaugeno, x, y, t1, t2])
    ...
    return rundata, geoflooddata, flowgrades_data, setprobdata
...
if __name__ == '__main__':
    ...
    rundata,geoflooddata,flowgrades_data,setprobdata = setrun(*sys.argv[1:])
    rundata.write()
    geoflood.write_data_outputs(rundata,geoflooddata,flowgrades_data,setprobdata)
