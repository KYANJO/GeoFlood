function plot_malpassetdam()

close all;

% plot_topo('scratch/Malpasset/malpasset_damapproach_1m_nolc.topotype2','g');
% plot_topo('scratch/Malpasset/ malpasset_domaingrid_20m_nolc.topotype2','b');
% plot_topo('scratch/Malpasset/malpasset_grid2_1m_nolc.topotype2','r');
[ax,bx,ay,by] = plot_topo('scratch/Malpasset/malpasset_domaingrid_20m_nolc.topotype2','w');
