! ==================================================================
subroutine fc2d_geoflood_bc2(meqn,mbc,mx,my,xlower,ylower,dx,dy,q,maux,aux,t,dt,mthbc)
!  ==================================================================
...
! (mx+ibc,j) for ibc = 1,mbc, j = 1-mbc, my+mbc
    ...
    real(kind=8) :: h_0, u_0, hu_0,hu_1
    real(kind=8) :: h_1, u_1,hu_n, h_n, u_n,g
    ...
    ! if (t == 0) then
        do j = 1-mbc,my+mbc
            ...
            do i = 1,100
                h_0 = ((u_0 - u_1 + 2*sqrt(g*h_1))**2)/(4.0d0*g)
                u_0 = hu_0/h_0
            enddo
...
! c     # user-specified boundary conditions go here in place of error output
    ...
    hu_n = q(2,mx,1)
    u_n = hu_n/h_n
    hu_n = 0.33d0*(u_n + 2*sqrt(9.81d08*h_n) - 2*sqrt(9.81d08*0.33d0))
